...
export default function About() {
  ...
  const funFacts = [
    ...
    },
    {
      ...
      description: 'When I\'m not coding or immersed in virtual realms, you might find me indulging in my love for cinema, with \'A Quiet Place\' holding a special place in my heart among my favourite titles.',
      icon: faFilm
    },
    {
